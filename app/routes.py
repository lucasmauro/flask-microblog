...
def unfollow(username):
    ...
    db.session.commit()
    flash(_('You are not following %(username)s any longer.', username=username))
    return redirect(url_for('user_profile', username=username))
...
@login_required
def translate_text():
    translated_text = translate(request.form['text'], request.form['source_language'], request.form['dest_language'])
